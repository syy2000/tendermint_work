...
type RequestTxValue struct {
	Cid         string `protobuf:"bytes,1,opt,name=Cid,proto3" json:"Cid,omitempty"`
	DataFeature string `protobuf:"bytes,2,opt,name=DataFeature,proto3" json:"DataFeature,omitempty"`
	DataValue   string `protobuf:"bytes,3,opt,name=DataValue,proto3" json:"DataValue,omitempty"`
}

func (m *RequestTxValue) Reset()         { *m = RequestTxValue{} }
func (m *RequestTxValue) String() string { return proto.CompactTextString(m) }
func (*RequestTxValue) ProtoMessage()    {}
func (*RequestTxValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{8}
}
func (m *RequestTxValue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestTxValue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestTxValue.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestTxValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestTxValue.Merge(m, src)
}
func (m *RequestTxValue) XXX_Size() int {
	return m.Size()
}
func (m *RequestTxValue) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestTxValue.DiscardUnknown(m)
}

var xxx_messageInfo_RequestTxValue proto.InternalMessageInfo

func (m *RequestTxValue) GetCid() string {
	if m != nil {
		return m.Cid
	}
	return ""
...
func (m *RequestTxValue) GetDataFeature() string {
	if m != nil {
		return m.DataFeature
	}
	return ""
}

func (m *RequestTxValue) GetDataValue() string {
	if m != nil {
		return m.DataValue
	}
	return ""
...
type RequestCheckTx struct {
	...
	TxOp       []string             `protobuf:"bytes,2,rep,name=TxOp,proto3" json:"TxOp,omitempty"`
	TxObject   []string             `protobuf:"bytes,3,rep,name=TxObject,proto3" json:"TxObject,omitempty"`
	TxValue    []*RequestTxValue    `protobuf:"bytes,4,rep,name=TxValue,proto3" json:"TxValue,omitempty"`
	TxTimehash *types1.PoHTimestamp `protobuf:"bytes,5,opt,name=TxTimehash,proto3" json:"TxTimehash,omitempty"`
}
...
func (m *RequestCheckTx) GetTxId() int64 {
	if m != nil {
		return m.TxId
	}
	return 0
...
func (m *RequestCheckTx) GetTxOp() []string {
	if m != nil {
		return m.TxOp
	}
	return nil
...
func (m *RequestCheckTx) GetTxObject() []string {
	if m != nil {
		return m.TxObject
	}
	return nil
...
func (m *RequestCheckTx) GetTxValue() []*RequestTxValue {
	if m != nil {
		return m.TxValue
	}
	return nil
...
func (m *RequestCheckTx) GetTxTimehash() *types1.PoHTimestamp {
	if m != nil {
		return m.TxTimehash
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RequestTxValue)(nil), "tendermint.abci.RequestTxValue")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
func (m *RequestTxValue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestTxValue) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestTxValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.DataValue) > 0 {
		...
		i = encodeVarintTypes(dAtA, i, uint64(len(m.DataValue)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.DataFeature) > 0 {
		i -= len(m.DataFeature)
		copy(dAtA[i:], m.DataFeature)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.DataFeature)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Cid) > 0 {
...
func (m *RequestCheckTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TxValue) > 0 {
		for iNdEx := len(m.TxValue) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.TxValue[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.TxObject) > 0 {
		for iNdEx := len(m.TxObject) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TxObject[iNdEx])
			copy(dAtA[i:], m.TxObject[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.TxObject[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if len(m.TxOp) > 0 {
		for iNdEx := len(m.TxOp) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TxOp[iNdEx])
			copy(dAtA[i:], m.TxOp[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.TxOp[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *RequestTxValue) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestCheckTx) Size() (n int) {
	...
	if len(m.TxOp) > 0 {
		for _, s := range m.TxOp {
			l = len(s)
			n += 1 + l + sovTypes(uint64(l))
		}
	}
	if len(m.TxObject) > 0 {
		for _, s := range m.TxObject {
			l = len(s)
			n += 1 + l + sovTypes(uint64(l))
		}
	}
	if len(m.TxValue) > 0 {
		for _, e := range m.TxValue {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *RequestTxValue) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestTxValue: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestTxValue: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DataFeature", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DataFeature = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *RequestCheckTx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TxOp = append(m.TxOp, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxObject", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TxObject = append(m.TxObject, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxValue", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TxValue = append(m.TxValue, &RequestTxValue{})
			if err := m.TxValue[len(m.TxValue)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			...
			if m.TxTimehash == nil {
				m.TxTimehash = &types1.PoHTimestamp{}
			}
